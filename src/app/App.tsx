...
import type { ExportDocumentDto } from "../shared/export";
import { bytesToPngDataUrl, createEditablePptxFile } from "./export/editable-pptx";
...
const MOCK_ISSUES: Issue[] = [
  ...
  { id: "v3", ruleId: "visual.gradient-fill", fixAvailable: true, fixLabel: "Заменить градиент на цвет из центра", nodeId: "mock-gradient", group: "visual", severity: "critical", title: "Градиент заменится сплошным цветом", slide: "Слайд 1 — Cover", layer: "Background gradient", why: "Figma официально предупреждает: gradient fills при PPTX-экспорте заменяются на solid color.", fix: "Заменить на цвет из центральной точки градиента или растеризовать фон." },
  { id: "v4", ruleId: "visual.background-blur", fixAvailable: true, fixLabel: "Удалить background blur", nodeId: "mock-background-blur", group: "visual", severity: "warning", title: "Background blur не поддерживается", slide: "Слайд 4 — Stats", layer: "Glass card / Blur bg", why: "Background blur в PPTX превращается в прозрачность без размытия.", fix: "Растеризовать карточку как PNG." },
  { id: "v5", ruleId: "visual.multiple-shadows", fixAvailable: true, fixLabel: "Оставить одну тень", nodeId: "mock-shadows", group: "visual", severity: "warning", title: "Drop shadow может пропасть", slide: "Слайд 7 — Pricing", layer: "Card / Drop shadow", why: "PPTX поддерживает тени, но параметры Figma (spread, multi-shadow) могут не перенестись.", fix: "Упростить тень или растеризовать карточку." },
  { id: "t1", ruleId: "text.non-system-font", fixAvailable: true, fixLabel: "Заменить на Arial", nodeId: "mock-font", group: "text", severity: "critical", title: "Отсутствует шрифт: Gilroy-Bold", slide: "Слайды 1, 3, 5, 9", layer: "Несколько текстовых слоёв", why: "Шрифт Gilroy-Bold недоступен в PowerPoint. Все тексты заменятся на Calibri.", fix: "Установить шрифт на целевой машине или заменить на Arial Bold." },
  ...
  { id: "s1", ruleId: "structure.nested-frame", fixAvailable: true, fixLabel: "Заменить простой фрейм на группу", nodeId: "mock-nested-frame", group: "structure", severity: "critical", title: "Вложенный фрейм", slide: "Слайд 5 — Timeline", layer: "Content / Frame inside frame", why: "Вложенные фреймы не поддерживаются в Figma Slides. Слайд может не скопироваться.", fix: "Заменить простой вложенный фрейм на группу." },
