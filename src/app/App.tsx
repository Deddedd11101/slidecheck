...
const MOCK_ISSUES: Issue[] = [
  ...
  { id: "v3", ruleId: "visual.gradient-fill", fixAvailable: true, fixLabel: "Заменить градиент на сплошной цвет", nodeId: "mock-gradient", group: "visual", severity: "critical", title: "Градиент заменится сплошным цветом", slide: "Слайд 1 — Cover", layer: "Background gradient", why: "Figma официально предупреждает: gradient fills при PPTX-экспорте заменяются на solid color.", fix: "Заменить на ближайший сплошной цвет или растеризовать фон." },
